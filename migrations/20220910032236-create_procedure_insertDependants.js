module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      `CREATE PROCEDURE insertDependants(
        @request_id INTEGER,
        @family_id INTEGER,
        @surname VARCHAR(50),
        @forename VARCHAR(50),
      ...
      SELECT TOP 1 @city = city FROM tbl_profiles WHERE family_id = @family_id
      ...
      END
      SELECT @member_id AS profile_id,@request_id AS request_id,@request_status AS request_status_id
      COMMIT TRANSACTION
      END TRY
      BEGIN CATCH
